...
import com.mulesoft.connectors.leanixconnectormule4.internal.metadata.GetSynchronizationRunResultsUrlOutputMetadataResolver;
...
public class GetSynchronizationRunResultsUrlOperation extends BaseRestOperation {
  private static final String OPERATION_PATH = "/synchronizationRuns/{id}/resultsUrl";

  private static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT =
      RestRequestBuilder.QueryParamFormat.MULTIMAP;

  public GetSynchronizationRunResultsUrlOperation() {}

  /**
   * Returns the url to the results of a finished synchronization run
   *
   * <p>This operation makes an HTTP GET request to the /synchronizationRuns/{id}/resultsUrl
   * endpoint
   *
  ...
  @DisplayName("Get Synchronization Run Results Url")
  @Summary("Returns the url to the results of a finished synchronization run")
  @MediaType("application/json")
  @OutputResolver(output = GetSynchronizationRunResultsUrlOutputMetadataResolver.class)
  public void getSynchronizationRunResultsUrl(
