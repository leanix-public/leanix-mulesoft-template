...
import com.mulesoft.connectors.leanixconnectormule4.internal.metadata.GetSynchronizationRunsStatusListOutputMetadataResolver;
...
public class GetSynchronizationRunsStatusListOperation extends BaseRestOperation {
  ...
  public GetSynchronizationRunsStatusListOperation() {}

  /**
   * Returns the status of all existing synchronization runs
   *
   * <p>This operation makes an HTTP GET request to the /synchronizationRuns endpoint
   *
  ...
  @DisplayName("Get Synchronization Runs Status List")
  @Summary("Returns the status of all existing synchronization runs")
  @MediaType("application/json")
  @OutputResolver(output = GetSynchronizationRunsStatusListOutputMetadataResolver.class)
  public void getSynchronizationRunsStatusList(
