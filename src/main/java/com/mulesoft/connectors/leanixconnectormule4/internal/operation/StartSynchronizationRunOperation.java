...
import com.mulesoft.connectors.leanixconnectormule4.internal.metadata.StartSynchronizationRunOutputMetadataResolver;
...
public class StartSynchronizationRunOperation extends BaseRestOperation {
  private static final String OPERATION_PATH = "/synchronizationRuns/{id}/start";

  private static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT =
      RestRequestBuilder.QueryParamFormat.MULTIMAP;

  public StartSynchronizationRunOperation() {}

  /**
   * Starts an existing but not yet started synchronization run
   *
   * <p>This operation makes an HTTP POST request to the /synchronizationRuns/{id}/start endpoint
   *
  ...
  @DisplayName("Start Synchronization Run")
  @Summary("Starts an existing but not yet started synchronization run")
  @MediaType("application/json")
  @OutputResolver(output = StartSynchronizationRunOutputMetadataResolver.class)
  public void startSynchronizationRun(
