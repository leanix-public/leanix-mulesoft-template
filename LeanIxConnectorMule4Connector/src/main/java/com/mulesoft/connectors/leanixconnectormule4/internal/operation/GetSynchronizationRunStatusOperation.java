...
import com.mulesoft.connectors.leanixconnectormule4.internal.metadata.GetSynchronizationRunStatusOutputMetadataResolver;
...
public class GetSynchronizationRunStatusOperation extends BaseRestOperation {
  private static final String OPERATION_PATH = "/synchronizationRuns/{id}/status";

  private static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT =
      RestRequestBuilder.QueryParamFormat.MULTIMAP;

  public GetSynchronizationRunStatusOperation() {}

  /**
   * Returns the status of an existing synchronization run
   *
   * <p>This operation makes an HTTP GET request to the /synchronizationRuns/{id}/status endpoint
   *
  ...
  @DisplayName("Get Synchronization Run Status")
  @Summary("Returns the status of an existing synchronization run")
  @MediaType("application/json")
  @OutputResolver(output = GetSynchronizationRunStatusOutputMetadataResolver.class)
  public void getSynchronizationRunStatus(
