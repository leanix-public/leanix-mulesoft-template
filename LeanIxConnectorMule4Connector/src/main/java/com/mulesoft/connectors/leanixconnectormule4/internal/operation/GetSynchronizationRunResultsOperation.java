...
import com.mulesoft.connectors.leanixconnectormule4.internal.metadata.GetSynchronizationRunResultsOutputMetadataResolver;
...
public class GetSynchronizationRunResultsOperation extends BaseRestOperation {
  private static final String OPERATION_PATH = "/synchronizationRuns/{id}/results";

  private static final RestRequestBuilder.QueryParamFormat QUERY_PARAM_FORMAT =
      RestRequestBuilder.QueryParamFormat.MULTIMAP;

  public GetSynchronizationRunResultsOperation() {}

  /**
   * Returns the results of a finished synchronization run
   *
   * <p>This operation makes an HTTP GET request to the /synchronizationRuns/{id}/results endpoint
   *
  ...
  @DisplayName("Get Synchronization Run Results")
  @Summary("Returns the results of a finished synchronization run")
  @MediaType("application/json")
  @OutputResolver(output = GetSynchronizationRunResultsOutputMetadataResolver.class)
  public void getSynchronizationRunResults(
